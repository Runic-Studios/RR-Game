...
object RogueTreeUtil {
    ...
    fun nightcrawlerPerkList(): List<Perk> =
        listOf(
            ...
            PerkBaseStat(109, 1, StatType.STRENGTH, maxAllocatedPoints = 3),
            ...
            PerkBaseStat(117, 1, StatType.DEXTERITY, maxAllocatedPoints = 3),
    ...
    fun witchHunterPerkList(): List<Perk> =
        listOf(
            ...
            PerkBaseStat(121, 1, StatType.DEXTERITY, maxAllocatedPoints = 3),
            ...
            PerkBaseStat(129, 1, StatType.INTELLIGENCE, maxAllocatedPoints = 3),
    ...
    fun corsairPerkList(): List<Perk> =
        listOf(
            ...
            PerkBaseStat(133, 1, StatType.STRENGTH, maxAllocatedPoints = 3),
            ...
            PerkBaseStat(141, 1, StatType.VITALITY, maxAllocatedPoints = 3),
