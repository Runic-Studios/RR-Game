...
object RogueTreeUtil {
    ...
    fun nightcrawlerPerkList(): List<Perk> =
        listOf(
            ...
            PerkBaseStat(109, 1, StatType.STRENGTH, 5),
            PerkSpell(110, 1, "Backstab"),
            PerkBaseStat(111, 1, StatType.DEXTERITY, 3),
            PerkBaseStat(112, 1, StatType.STRENGTH, 3),
            PerkSpell(113, 1, "Cocoon"),
            PerkBaseStat(114, 1, StatType.DEXTERITY, 3),
            PerkBaseStat(115, 1, StatType.STRENGTH, 3),
            PerkBaseStat(117, 1, StatType.DEXTERITY, 5),
            PerkSpell(116, 1, "Unseen"),
            PerkBaseStat(118, 1, StatType.STRENGTH, 3),
    ...
    fun witchHunterPerkList(): List<Perk> =
        listOf(
            ...
            PerkBaseStat(121, 1, StatType.DEXTERITY, 5),
            PerkSpell(122, 1, "Castigate"),
            PerkBaseStat(123, 1, StatType.INTELLIGENCE, 3),
            PerkBaseStat(124, 1, StatType.DEXTERITY, 3),
            PerkSpell(125, 1, "Flay"),
            PerkBaseStat(126, 1, StatType.INTELLIGENCE, 3),
            PerkBaseStat(127, 1, StatType.DEXTERITY, 3),
            PerkBaseStat(129, 1, StatType.INTELLIGENCE, 5),
            PerkSpell(128, 1, "Warding Glyph"),
            PerkBaseStat(130, 1, StatType.DEXTERITY, 3),
    ...
    fun corsairPerkList(): List<Perk> =
        listOf(
            ...
            PerkBaseStat(133, 1, StatType.STRENGTH, 5),
            PerkSpell(134, 1, "Scurvy"),
            PerkBaseStat(135, 1, StatType.VITALITY, 3),
            PerkBaseStat(136, 1, StatType.STRENGTH, 3),
            PerkSpell(137, 1, "Whirlpool"),
            PerkBaseStat(138, 1, StatType.VITALITY, 3),
            PerkBaseStat(139, 1, StatType.STRENGTH, 3),
            PerkBaseStat(141, 1, StatType.VITALITY, 5),
            PerkSpell(140, 1, "Harpoon"),
            PerkBaseStat(142, 1, StatType.STRENGTH, 3),
