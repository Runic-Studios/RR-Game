 ...
 * [PhysicalDamageEvent], [MobDamageEvent], and [EnvironmentDamageEvent]. When a shield
 * is exhausted, [ShieldBreakEvent] is fired.
 *
 ...
 * - On damage events: absorb damage from shield first, reduce shield HP, fire ShieldBreakEvent if depleted
...
constructor(private val plugin: Plugin) : Listener {
    ...
    fun onSpellShield(event: SpellShieldEvent) {
        ...
        //   val shieldPayload = ShieldPayload(event.recipient, event.amount, System.currentTimeMillis() + SHIELD_DURATION_MS)
