...
/**
 * Forwards player damage events to [com.runicrealms.game.items.loot.BossTimedLootManager] so it can
 * track per-player damage contribution for boss loot eligibility thresholds.
 *
