...
/** Buff on caster. Plays HelixParticleFrame (SPELL_WITCH) once per second. */
class ArcanumEffect(
    ...
    override val effectType = SpellEffectType.ARCANUM
    ...
    override fun executeSpellEffect() {
        helix.playParticle(caster, Particle.WITCH, caster.location, 0.2)
    }
