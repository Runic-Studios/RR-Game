...
object WarriorTreeUtil {
    ...
    fun berserkerPerkList(): List<Perk> =
        listOf(
            ...
            PerkBaseStat(145, 1, StatType.STRENGTH, 5),
            PerkSpell(146, 1, "Rupture"),
            PerkBaseStat(147, 1, StatType.VITALITY, 3),
            PerkBaseStat(148, 1, StatType.STRENGTH, 3),
            PerkSpell(149, 1, "Axe Toss"),
            PerkBaseStat(150, 1, StatType.VITALITY, 3),
            PerkBaseStat(151, 1, StatType.STRENGTH, 3),
            PerkBaseStat(152, 1, StatType.VITALITY, 5),
            PerkSpell(153, 1, "Adrenaline"),
            PerkBaseStat(154, 1, StatType.STRENGTH, 3),
    ...
    fun dreadlordPerkList(): List<Perk> =
        listOf(
            ...
            PerkBaseStat(157, 1, StatType.VITALITY, 5),
            PerkSpell(158, 1, "Soul Reaper"),
            PerkBaseStat(159, 1, StatType.INTELLIGENCE, 3),
            PerkBaseStat(160, 1, StatType.VITALITY, 3),
            PerkSpell(161, 1, "Umbral Grasp"),
            PerkBaseStat(162, 1, StatType.INTELLIGENCE, 3),
            PerkBaseStat(163, 1, StatType.VITALITY, 3),
            PerkBaseStat(164, 1, StatType.INTELLIGENCE, 5),
            PerkSpell(165, 1, "Damnation"),
            PerkBaseStat(166, 1, StatType.VITALITY, 3),
    ...
    fun paladinPerkList(): List<Perk> =
        listOf(
            ...
            PerkBaseStat(169, 1, StatType.VITALITY, 5),
            PerkSpell(170, 1, "Consecrate"),
            PerkBaseStat(171, 1, StatType.WISDOM, 3),
            PerkBaseStat(172, 1, StatType.VITALITY, 3),
            PerkSpell(173, 1, "Salvation"),
            PerkBaseStat(174, 1, StatType.WISDOM, 3),
            PerkBaseStat(175, 1, StatType.VITALITY, 3),
            PerkBaseStat(177, 1, StatType.WISDOM, 5),
            PerkSpell(176, 1, "Sacred Wings"),
            PerkBaseStat(178, 1, StatType.VITALITY, 3),
