...
object WarriorTreeUtil {
    ...
    fun berserkerPerkList(): List<Perk> =
        listOf(
            ...
            PerkBaseStat(145, 1, StatType.STRENGTH, maxAllocatedPoints = 5),
            ...
            PerkBaseStat(152, 1, StatType.VITALITY, maxAllocatedPoints = 5),
    ...
    fun dreadlordPerkList(): List<Perk> =
        listOf(
            ...
            PerkBaseStat(157, 1, StatType.VITALITY, maxAllocatedPoints = 5),
            ...
            PerkBaseStat(164, 1, StatType.INTELLIGENCE, maxAllocatedPoints = 5),
    ...
    fun paladinPerkList(): List<Perk> =
        listOf(
            ...
            PerkBaseStat(169, 1, StatType.VITALITY, maxAllocatedPoints = 5),
            ...
            PerkBaseStat(177, 1, StatType.WISDOM, maxAllocatedPoints = 5),
