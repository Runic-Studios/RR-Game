...
/**
 * This class represents any user that has connected to the server,
 * and that we have loaded their player data (but not necessarily character data).
 *
 * This class is internal only to the data module. No interaction with it
 * can occur outside.
 *
