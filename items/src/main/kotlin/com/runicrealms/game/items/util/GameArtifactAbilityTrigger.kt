...
enum class GameArtifactAbilityTrigger(val identifier: String, val display: TextComponent) {
    ON_CAST("on-cast", Component.text("ON CAST", Style.style(NamedTextColor.GOLD, TextDecoration.BOLD))),
    ON_HIT("on-hit", Component.text("ON HIT", Style.style(NamedTextColor.GOLD, TextDecoration.BOLD))),
    ON_KILL("on-kill", Component.text("ON KILL", Style.style(NamedTextColor.GOLD, TextDecoration.BOLD)));
